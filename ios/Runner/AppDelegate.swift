...
@objc class AppDelegate: FlutterAppDelegate, MessagingDelegate{
    ...
    override func application(        _ application: UIApplication,
        ...
        //genrated plugin registry
        GeneratedPluginRegistrant.register(with: self);
        
        // registering flutter downloder plugin
        ...
        if let controller = window?.rootViewController as? FlutterViewController {
            // creating and configuring clipboard channel
            configureClipboardChannel(controller: controller);
        }
        ...
        //
        // registering a background processing
    ...
    // this method will create a clipboard channel and register method calbacks
    private func configureClipboardChannel( controller : FlutterViewController){
        // clipboard channel
        let clipBoardChannel = FlutterMethodChannel( name: "clipboardChannel", binaryMessenger: controller.binaryMessenger)
        
        // registering a method call handler to clipboard channel
        clipBoardChannel.setMethodCallHandler { [weak self] (call, result) in
            self?.clipboardMethodHandler(call, result: result)
        }
    }
    
    // callback that handles the clipboard channel method calls
    private func clipboardMethodHandler(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        switch call.method {
