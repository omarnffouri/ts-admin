...
//  Runner
//
//  Created by Hashim Khan on 24/06/2024.
//
...
public class NativeCallingMethodChannel: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "join_ongoing_call" :
            ...
            CallManager.shared.joinOngoingCall(call: Call(uuid: tempCallID, callPayload: callPayload, isOutGoing : true , wasJoiningOngoingCall: true)) { success in
                result(success)
            }
