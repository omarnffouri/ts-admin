...
extension CallManager : CXProviderDelegate {
    ...
    func provider(_ provider: CXProvider, perform action: CXEndCallAction) {
        ...
        if(!call.hasConnected && !call.hasStartedConnecting && !call.isOutGoing && !call.wasJoiningOngoingCall){
            CallEventHelper.callRejected(payload: call.callPayload)
            
            CallChannel.shared.getCallChannel()?.trigger(eventName: "client-call-declined", data: [
                "calledBy": [
        ...
        else if call.isOutGoing && !call.hasConnected && !call.wasJoiningOngoingCall{
