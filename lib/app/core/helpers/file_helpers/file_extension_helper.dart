...
class FileExtensionHelper {
  ...
  //
  //
  /// this take a file path or url in param, and return a path of png icon from assets
  /// base on the FileTypes
  String getFileIconFromUrl(String path) {
    final type = getFileType(path);
