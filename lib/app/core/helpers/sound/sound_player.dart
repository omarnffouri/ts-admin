...
import 'package:ts_admin/app/core/helpers/sound/audio_player_manager.dart';
import 'package:ts_admin/app/core/helpers/sound/sound_widgets.dart';
...
class SoundPlayer extends StatefulWidget with WidgetsBindingObserver {
  ...
  final String myId;
  final getx.RxDouble? speed;
  final getx.Rxn<AudioPlayer> currentAudioPlayer;
  ...
  SoundPlayer({
    ...
    required this.myId,
    this.speed,
    required this.currentAudioPlayer,
  });
...
class ControlButtons extends StatelessWidget {
  ...
  const ControlButtons(this.player, this.isSenderView, {super.key});
