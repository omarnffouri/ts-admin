        ...
        child: DropdownSearch<T>(
          popupProps: PopupProps.modalBottomSheet(
              ...
              return Padding(
                padding: EdgeInsets.only(
                  bottom: MediaQuery.of(context)
                      .viewInsets
                      .bottom, // Padding to adjust for keyboard
                ),
                child: Column(
            ...
            searchFieldProps: TextFieldProps(
              decoration: InputDecoration(
                ...
                hintText: searchHint,
                focusedBorder:
                    _getBorderStyle(context, dropdownSearchDecoration, true),
                border:
                    _getBorderStyle(context, dropdownSearchDecoration, false),
                enabledBorder:
                    _getBorderStyle(context, dropdownSearchDecoration, false),
              ),
            ),
          ...
          dropdownDecoratorProps: DropDownDecoratorProps(
            dropdownSearchDecoration: InputDecoration(
              ...
              focusedBorder: _getBorderStyle(context, dropdownDecoration, true),
              border: _getBorderStyle(context, dropdownDecoration, false),
              enabledBorder:
                  _getBorderStyle(context, dropdownDecoration, false),
            ),
          ),
