...
class ConversationsDatabase {
  ...
  Future<int> updateConversation(ConversationEntity conversation) async {
    final db = await database;
  ...
  Future<GroupConversationEntity?> getGroupConversation(
    ...
    return groupConversations.isNotEmpty ? groupConversations.first : null;
  }

  Future<int> updateGroupConversation(
      String groupName, GroupConversationEntity groupConversationEntity) async {
    final db = await database;
    return await db.update(
        _groupConversationsTableName,
        {
          "conversation": jsonEncode(groupConversationEntity.toJson()),
        },
        where: 'group_name = ?',
        whereArgs: [groupName]);
  }
