...
class AddAdminParticipantsView extends GetView<AddAdminParticipantsController> {
  const AddAdminParticipantsView({super.key});
  @override
        ...
        child: Scaffold(
          body: Column(
            children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (controller.selectedAdmins.length !=
                            ...
                            controller.selectedAdmins.addAll(controller.admins);
                          } else {
                            controller.selectedAdmins.clear();
                          }
                        },
                ...
                child: Obx(
                  () =>
                      ...
                      controller.isLoadingGroupContacts
                          ...
                          //
                          // if all admins are already added then show this message
                          : controller.admins.isEmpty
                              ...
                              : (controller.isSearchEnabled &&
                                      controller.filteredAdmins.isEmpty)
                                  ? Center(
                                      child: Text(
                                        "No Result",
                                        style: theme.textTheme.labelLarge,
              ...
              Obx(
                () => Visibility(
                  visible: controller.selectedAdmins.isNotEmpty ||
                  ...
                  child: BounceInUp(
                    ...
                    child: MainAppButton(
                      ...
                      trailingIcon: Container(
                        ...
                        child: Obx(
                          () => Text(
                            controller.selectedAdmins.length.toString(),
                      ...
                      onPressed: () {
                        if (controller.selectedAdmins.isEmpty) {
                          ...
                          final params = AddParticipantsParams(
                            ...
                            participants: controller.selectedAdmins
                                .map(
...
class _Header extends GetView<AddAdminParticipantsController> {
  const _Header();
...
class _ContactItemView extends GetView<AddAdminParticipantsController> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        if (controller.selectedAdmins.contains(contact)) {
          controller.selectedAdmins.remove(contact);
        } else {
          controller.selectedAdmins.add(contact);
        }
      },
      child: Container(
        margin: index == 0
        ...
        child: Row(
          children: [
            ...
            Obx(
              () => Icon(
                controller.selectedAdmins.contains(contact)
                    ? Icons.check_box_rounded
                    : Icons.check_box_outline_blank_rounded,
                color: controller.selectedAdmins.contains(contact)
                    ? AppColorsLight.mainColor
                    : Colors.grey,
              ),
            )
