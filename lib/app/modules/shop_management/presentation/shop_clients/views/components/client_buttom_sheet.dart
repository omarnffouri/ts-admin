...
class ClientButtomSheet extends StatelessWidget {
  const ClientButtomSheet({super.key, required this.client});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
              client.companyName ?? 'No Name Provided',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _buildDetailRow('Contact Number', client.contactNumber),
                _buildDetailRow('Email', client.email),
                _buildDetailRow('Address', client.address),
                _buildDetailRow('Tax Number', client.taxNumber),
              ],
            ),
          ),
