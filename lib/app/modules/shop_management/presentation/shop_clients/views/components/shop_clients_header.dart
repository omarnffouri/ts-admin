...
class ShopClientsHeader extends GetView<ShopClientsController> {
  const ShopClientsHeader({super.key});
...
class _HeaderSearchField extends StatelessWidget {
  ...
  final ShopClientsController controller;
      ...
      children: [
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Search by company name'.tr,
              hintStyle: TextStyle(
        ...
        Obx(
          () {
            ...
            return Text(
              '$count ${count == 1 ? 'client' : 'clients'} found',
