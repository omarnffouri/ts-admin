...
class ShopSuppliersHeader extends GetView<ShopSuppliersController> {
  const ShopSuppliersHeader({super.key});
...
class _HeaderSearchField extends StatelessWidget {
  ...
  final ShopSuppliersController controller;
      ...
      children: [
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Search by supplier name'.tr,
              hintStyle: TextStyle(
        ...
        Obx(
          () {
            ...
            return Text(
              '$count ${count == 1 ? 'supplier' : 'suppliers'} found',
