...
class TechniciansHeader extends GetView<TechniciansController> {
  const TechniciansHeader({super.key});
...
class _HeaderSearchField extends StatelessWidget {
  ...
  final TechniciansController controller;
      ...
      children: [
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Search by technician name'.tr,
              hintStyle: TextStyle(
        ...
        Obx(
          () {
            ...
            return Text(
              '$count ${count == 1 ? 'technician' : 'technicians'} found',
