...
class UpdateShipmentTemplateUsecase
    extends BaseUseCase<BaseResponse<bool>, FormData> {
  final IShipmentRepository shipmentRepository;

  UpdateShipmentTemplateUsecase({required this.shipmentRepository});

  @override
  Future<Either<BaseResponse<bool>, Failure>> call(FormData params) async {
    return await shipmentRepository.updateShipmentTemplate(params);
  }
}
