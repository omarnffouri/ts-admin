...
class InvoicePaymentsRevertController extends GetxController {
  final authController = Get.find<AuthController>();

  final Rx<InvoicePaymentsRevertTabs> currentTab =
      InvoicePaymentsRevertTabs.pending.obs;
  ...
  Future<void> getPendingInvoicePayments() async {
    try {
      ...
      final Either<BaseResponse<List<InvoicePaymentEntity>>, Failure> result =
        ...
        action: InvoicePaymentActions.delete,
...
enum InvoicePaymentsRevertTabs { pending, approved, rejected }
