...
// the plus icon will be used to add more reactions
  ...
  // default info menu item
  static const ReactionsMenuItem info = ReactionsMenuItem(
    id: 6,
    label: 'Info',
    icon: Icons.info_outline_rounded,
  );

  // default buzz menu item
  static const ReactionsMenuItem buzz = ReactionsMenuItem(
    id: 7,
    label: 'Buzz',
