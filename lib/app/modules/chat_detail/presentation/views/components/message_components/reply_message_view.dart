  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSenderView
            ? Get.isDarkMode
                ? const Color.fromARGB(255, 66, 29, 29)
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: isSenderView
                  ? Get.isDarkMode
                      ? const Color.fromARGB(255, 158, 98, 98)
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                      color: !isSenderView ? Colors.white70 : Colors.grey,
                      fontSize: 12),
                ).marginOnly(bottom: 5),
                Row(
                  children: [
                    ...
                    Expanded(
                      ...
                      maxLines: 2,
                        ...
                        //     style: TextStyle(
                        //       color:
                        //           isSenderView ? Colors.grey : Colors.white70,
                        //       fontSize: 12,
                        //     ),
                        //   ),
                        ),
