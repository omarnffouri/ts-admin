...
class GetTruckDetailsUsecase extends BaseUseCase<VehicleDetailsEntity, Body> {
  IAssetsRepository repository;
  GetTruckDetailsUsecase({required this.repository});

  @override
  Future<Either<VehicleDetailsEntity, Failure>> call(Body params) async {
    return await repository.getTruckDetails(params);
  }
}
