...
class TrailerDocumentItem extends GetView<TrailerDetailsController> {
  const TrailerDocumentItem({super.key, required this.index});
  final int index;

  @override
  Widget build(BuildContext context) {
    final theme = Get.theme.textTheme;
    final document = controller.trailerDocuments[index];
    return Stack(
      children: [
        IntrinsicHeight(
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: ValueListenableBuilder<String?>(
                  valueListenable:
                      controller.trailerDocuments[index].selectedTypeNotifier,
                  builder: (_, value, __) {
                    return DropdownButtonFormField<String>(
                      ...
                      onChanged: (newValue) {
                        controller.trailerDocuments[index].selectedTypeNotifier
                            .value = newValue;
                        controller.trailerDocuments[index]
                            .selectedCollectionType.value = newValue!;
                      },
                  ...
                  if (file != null) {
                    ...
                    return Stack(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible:
                              index != controller.trailerDocuments.length - 1,
                          child: Positioned(
                            bottom: -4,
                            right: -2,
                    ...
                    return InkWell(
                      onTap: () async {
                        ...
                        if (doc != null) {
                          controller
                              .trailerDocuments[index].selectedFile.value = doc;
                        }
                      },
                      child: Container(
                        height: double.infinity,
              ...
              const SizedBox(width: 8),
              if (index != controller.trailerDocuments.length - 1)
                GestureDetector(
                  onTap: () {
                    document.selectedFile.value = null;
                    controller.removeTrailerDocument(index);
                  },
                  child: Container(
                    decoration: BoxDecoration(
