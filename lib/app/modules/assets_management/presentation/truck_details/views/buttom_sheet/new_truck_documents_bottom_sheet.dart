...
import '../components/truck_document_item.dart';

class NewTruckDocumentButtomsheet extends StatelessWidget {
  const NewTruckDocumentButtomsheet({
    super.key,
            ...
            itemBuilder: (context, index, animation) {
              return SizeTransition(
                ...
                child: Padding(
                  ...
                  child: TruckDocumentItem(index: index),
                ),
              );
            },
          ),
