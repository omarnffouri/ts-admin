...
class TrailersSearchAndFilter extends GetView<TrailersController> {
  const TrailersSearchAndFilter({super.key});
...
class _SearchField extends StatelessWidget {
  ...
  final TrailersController controller;
