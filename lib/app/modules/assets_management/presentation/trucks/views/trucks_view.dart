...
import 'components/trucks_body.dart';
import 'components/trucks_empty_state.dart';
import 'components/trucks_loading_view.dart';
import 'components/trucks_search_and_filter.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: SafeArea(
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () {
            Get.toNamed(Routes.CREATE_TRUCK);
          },
  ...
  Widget _buildContentSliver() {
    ...
    if (controller.trucks.isEmpty) {
      ...
      return SliverFillRemaining(
        hasScrollBody: false,
        child: TrucksEmptyState(
          isSearching: isSearching,
          isFiltering: isFiltering,
          onAddTruck: () => Get.toNamed(Routes.CREATE_TRUCK),
          onClearSearch: () {
