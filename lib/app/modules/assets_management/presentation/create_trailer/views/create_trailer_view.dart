...
class CreateTrailerView extends GetView<CreateTrailerController> {
  const CreateTrailerView({super.key});
          ...
          body: Column(
            children: [
              CreateVehicleProgressHeader(
                title: '${controller.isUpdate ? 'Update' : 'Create'} Trailer',
                currentStep: controller.vehicleCreationState.value,
                totalSteps: VehicleCreationStates.values.length,
