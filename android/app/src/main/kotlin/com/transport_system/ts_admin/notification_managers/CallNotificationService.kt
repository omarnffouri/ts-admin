package com.transport_system.ts_admin.notification_managers
...
import com.transport_system.ts_admin.helpers.VibrationHelper
import com.transport_system.ts_admin.pusher.channels.call_channel.channel.CallChannel
import com.transport_system.ts_admin.pusher.channels.call_channel.events.CallAcceptedWhisperEvent
import com.transport_system.ts_admin.pusher.channels.call_channel.events.CallDeclinedWhisperEvent
...
class CallNotificationService : Service() {
    ...
    override fun onCreate() {
        ...
        CallAcceptedWhisperEvent.initialize(context = applicationContext).bind()
        CallDeclinedWhisperEvent.initialize(context = applicationContext).bind()
    }
    ...
    override fun onDestroy() {
        ...
        CallAcceptedWhisperEvent.initialize(context = applicationContext).unbind()
        CallDeclinedWhisperEvent.initialize(context = applicationContext).unbind()
