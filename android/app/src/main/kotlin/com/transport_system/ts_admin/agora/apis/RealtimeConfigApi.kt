...
// call always joins with a fresh app id. `onComplete` always fires (success,
// mismatch-write, or failure) so the call flow proceeds and degrades to the
// existing prefs / hardcoded fallback.
